...
namespace hajo
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            AktualisKérdés = new List<Kérdés>();
            ...
            KérdésMegjelenítés(AktualisKérdés[MegjelenítettKérdésSzáma]);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (MegjelenítettKérdésSzáma == AktualisKérdés.Count) MegjelenítettKérdésSzáma = 0;
        ...
        void Színezés()
        {
            int helyesVálasz = AktualisKérdés[MegjelenítettKérdésSzáma].HelyesVálasz;

            if (helyesVálasz == 1) textBox1.BackColor = Color.LightGreen;
            if (helyesVálasz == 2) textBox3.BackColor = Color.LightGreen;
            if (helyesVálasz == 3) textBox2.BackColor = Color.LightGreen;
